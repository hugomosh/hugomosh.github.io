...
var calculateGrid = function calculateGrid(container) {
...
var resize = function resize() {
  ...
  if (newSize >= currentSize) {
    ...
    var lLen_1 = list.length;
    new Array(lLen_1 - newSize).fill(undefined).forEach(function (_, i) {
      list[lLen_1 - 1 - i].classList.add("hidden");
    });
  }
...
var start = function start(_a) {
  ...
  list = new Array(currentSize).fill(undefined).map(function (_, i) {
    var e = document.createElement("div");
    e.className = "square";
    e.style.backgroundColor = getRandomColor();
...
grid_1.default.start({
  parentElement: body
});
},{"./grid":"grid.ts"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/tryParcel.77de5100.js.map